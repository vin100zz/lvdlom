...
(function () {
  ...
  app.controller('AvancementCtrl', function($scope, $routeParams, Avancement) {
    ...
    var computeAvancement = function (order, type, items, icon, title, link, colorDone, colorNotDone, keyFn, keyDisplayFn, tooltipFn) {
      var avancement = {};
    ...
    Avancement.get(null, function (data) {
      // matches
      computeAvancement(1, 'matches', data.matches, 'futbol-o', 'Matches', 'match', '#009688', '#E0F2F1',
                        function (match) {return match.saison;},
                        function (key) {return key;},
                        function (match) {return match.adversaire + ' ' + match.butsOM + '-' + match.butsAdv;});

      // joueurs
      computeAvancement(2, 'joueurs', data.joueurs, 'user', 'Joueurs', 'joueur', '#673AB7', '#EDE7F6',
      ...
      // dirigeants
      computeAvancement(3, 'dirigeants', data.dirigeants, 'briefcase', 'Dirigeants', 'dirigeant', '#FF9800', '#FFF3E0',
      ...
      // saisons
      computeAvancement(4, 'saisons', data.saisons, 'history', 'Saisons', 'saison', '#4CAF50', '#E8F5E9',
